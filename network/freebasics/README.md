...
- [Países e operadoras](#países-e-operadoras)
    - [Lista completa de todos os países e operadoras](#lista-completa-de-todos-os-países-e-operadoras)
    - [Nosso público](#nosso-público)
        - [Tem acesso via Free Basics](#tem-acesso-via-free-basics)
            - [Angola](#angola)
            - [Cabo Verde](#cabo-verde)
            - [Guiné-Bissau](#guiné-bissau)
            - [Moçambique](#moçambique)
            - [Timor-Leste](#timor-leste)
        - [Não tem acesso via Free Basics](#não-tem-acesso-via-free-basics)
            - [Brasil](#brasil)
            - [Guiné Equatorial](#guiné-equatorial)
            - [Macau](#macau)
            - [Portugal](#portugal)
            - [São Tomé e Príncipe](#são-tomé-e-príncipe)
- [Como adicionar um site](#como-adicionar-um-site)
...
### Lista completa de todos os países e operadoras

A lista completa pode ser vista em [Internet.org: Where we’ve launched ➚ <sup>Destino em Inglês</sup>](https://info.internet.org/en/story/where-weve-launched/).
...
- Argumento: _"O Free Basics fere a neutralidade da internet ao diferenciar acesso de um site em relação aos demais"_
  - Este argumento é verdadeiro. Porém note que no Brasil operadoras já fazem
    ...
    a ainda menos opções (apenas o Facebook/WhatsApp/Etc) do que o Free Basics,
    que seria gratuito, definido pelas Diretrizes Técnicas. Ou seja:
    **a pressão de _especialistas em internet_ do Brasil atingiu um resultado
...
disponível também neste país.

Se souber, por favor nos avise.
...
Para adicionar um novo site no Free Basics, recomendamos

- [Introdução ao Free Basics (em português) ➚](https://developers.facebook.com/docs/internet-org/gettingstarted?locale=pt_BR)
- [Diretrizes de Participação (em português) ➚](https://developers.facebook.com/docs/internet-org/participation-guidelines?locale=pt_BR)
- [Diretrizes Técnicas (em português) ➚](https://developers.facebook.com/docs/internet-org/platform-technical-guidelines?locale=pt_BR)

Este projeto também foi cadastrado para ser fornecido no Free Basics! A situação
pode ser acompanhada em <https://github.com/fititnt/recursos-desenvolvimento-periferia/issues/1>
